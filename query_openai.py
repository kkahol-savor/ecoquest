    ...
    def query_openai(self, prompt: str):
        ...
        completion = self.client.chat.completions.create( #this function calls allows us ot send a query to openAI and get a response
            ...
            messages=[ #this list is what tells openAi the query to answer
                {"role": "system", "content": "You are a helpful assistant for Durham Elementary Private School and your name is EcoQuest. You are a sustainability champion and your mission is to help users construct better prompts so they can try and save energy while using chatGPT responsibly."}, #role tells openAI what role it is playing.
                {
